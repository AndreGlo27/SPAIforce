(function () {
  ...
  var navLinksOnClick = document.querySelectorAll('a.nav-link');
  ...
  // var texts = ["Grow", "Digitalize","Manage"]; // Array of text to display
  // var currentIndex = 0;
  ...
  //         $(".item").css("transition","moveUp 0.2s ease");
  ...
  // setInterval(slideText, 5000); // Change interval as needed (milliseconds)
  
  

  const {children: titles} = document.querySelector(".content-animate");
  ...
  $(".nextSlide").click(function() {
    ...
    }else if(pillsDisabledActive && pillsDisabledTabActive){
  ...
  $(".prevSlide").click(function() {
    ...
    else if(pillsHomeActive && pillsHomeTabActive){
      pillsHomeTab.removeClass("active")
      pillsHome.removeClass("active")
      pillsHome.removeClass("fade")
      pillsHome.removeClass("show")
...
$(".btnContactUs").click(function () { 
  window.location = "mailto:info@iforce.co.id"
